...
const int led = 9; // LED or connect it to Motor, as output
...
//Output is our u(t)
//Setpoint is our SP
const int sampleRate = 2; // Variable that determines how fast our PID loop runs
...
void setup(){
  ...
  // I1, I2 and led or motor as output pins
  pinMode(led, OUTPUT);
...
void loop(){
  ...
  Input = map(lightLevel, 720, 1023, 0, 255); //Map it to the right scale
